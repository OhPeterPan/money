...
public abstract class BaseListPopupWindow<T> extends PopupWindow implements BaseQuickAdapter.OnItemClickListener {
    ...
    public BaseListPopupWindow(Context context, List<T> data, int layoutId) {
        super(context);
        this.mData = data;
